...
def update_engagement_on_interaction(sender, created, instance, **kwargs):
    ...
    try:
        ...
        logger.error("Error updating engagement count on interaction: %s", e)
...
def update_engagement_on_interaction_delete(sender, instance, **kwargs):
    ...
    try:
        ...
        logger.error("Error updating engagement count on interaction delete: %s", e)
...
def update_engagement_on_repost(sender, created, instance, **kwargs):
    ...
    try:
        ...
        logger.error("Error updating engagement count on repost: %s", e)
...
def update_engagement_on_like(sender, created, instance, **kwargs):
    ...
    try:
        ...
        logger.error("Error updating engagement count on like: %s", e)
...
def update_engagement_on_comment(sender, created, instance, **kwargs):
    ...
    try:
        ...
        logger.error("Error updating engagement count on comment: %s", e)
...
def update_trust_score_on_booking_completion(sender, instance, created, **kwargs):
    ...
    try:
        ...
        logger.error("Error updating trust score on booking completion: %s", e)
...
def update_trust_score_on_endorsement(sender, instance, created, **kwargs):
    ...
    try:
        ...
        logger.error("Error updating trust score on endorsement creation: %s", e)
...
def update_trust_score_on_review(sender, instance, created, **kwargs):
    ...
    try:
        ...
        logger.error("Error updating trust score on rating creation: %s", e)
...
def update_user_last_active(sender, instance, created = None, **kwargs):
    ...
    try:
        ...
        logger.error("Error updating user last_active: %s", e)
