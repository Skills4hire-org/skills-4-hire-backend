...
from .views import PostViewSet, CommentViewSet, CommentLikeViewSet, FeedListView, PostInteractionViewSet, ExternalJobApplication
...
router.register(r'job/application', ExternalJobApplication, basename='open-application')
